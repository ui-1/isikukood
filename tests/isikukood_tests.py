...
class AssertionsTestCase(unittest.TestCase):
    def test_assert_ordernumber_range(self):
        self.assertRaises(ValueError, lambda: isikukood.assertions.assert_ordernumber_range(-1))
        self.assertRaises(ValueError, lambda: isikukood.assertions.assert_ordernumber_range(1000))

    def test_assert_numeric(self):
        try: isikukood.assertions.assert_numeric('123')
        except Exception as e: self.fail(e)

        self.assertRaises(ValueError, lambda: isikukood.assertions.assert_numeric('x'))
    ...
    def test_assert_gender(self):
        ...
        self.assertRaises(ValueError, lambda: isikukood.assertions.assert_gender('x'))

    def test_assert_first_digit(self):
        try: isikukood.assertions.assert_first_digit('5xxxxxxxxxx')
        except Exception as e: self.fail(e)

        self.assertRaises(ValueError, lambda: isikukood.assertions.assert_first_digit('0xxxxxxxxxx'))
        self.assertRaises(ValueError, lambda: isikukood.assertions.assert_first_digit('9xxxxxxxxxx'))

    def test_assert_year_range(self):
        try: isikukood.assertions.assert_year_range(2000)
        except Exception as e: self.fail(e)

        self.assertRaises(ValueError, lambda: isikukood.assertions.assert_year_range(1799))
        self.assertRaises(ValueError, lambda: isikukood.assertions.assert_year_range(2200))
    ...
    def test_assert_valid_ssn(self):
        self.assertRaises(ValueError, lambda: isikukood.assertions.assert_valid_ssn('50001x10006'))
        self.assertRaises(ValueError, lambda: isikukood.assertions.assert_valid_ssn('90001010006'))
        self.assertRaises(ValueError, lambda: isikukood.assertions.assert_valid_ssn('500010100060'))
...
class IsikukoodTestCase(unittest.TestCase):
    def test_instantiate(self):
        ...
        self.assertRaises((ValueError, AssertionError), lambda: Isikukood.from_ssn('38001085710'))

    def test_instantiate_from_ssn(self):
        try: Isikukood.from_ssn('50001010006')
        except ValueError as e: self.fail(e)
        self.assertRaises(AssertionError, lambda: Isikukood.from_ssn('50001010000'))
